...
export const ashleighHarris: Participant = {
	...
	country: 'Sweden',
	role: 'Participant',
	website: 'https://www.uu.se/en/contact-and-organisation/staff?query=N7-1606',
	...
	photoUrl: '/images/participants/ashleigh-harris.webp',
	questionsOfInterest: [
		'Addressing data inequality',
		'AI tools to address visibility of African Cultural heritage',
		'LLM training on African and African-language materials'
	]
};
