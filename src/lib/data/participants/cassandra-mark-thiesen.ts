...
export const cassandraMarkThiesen: Participant = {
	...
	country: 'Germany',
	role: 'Participant',
	website: 'https://www.uni-regensburg.de/en/university/dimas/team/dr-cassandra-mark-thiesen',
	...
	photoUrl: '/images/participants/cassandra-mark-thiesen.webp',
	questionsOfInterest: [
		'Layering Epistemic Dimensions of Audio, Visual, and Metadata',
		'Creating socially-integrated metadata enhancement',
		'Digital memory across the global north-global south divide'
	]
};
