...
export const janethDavidNzenga: Participant = {
	...
	questionsOfInterest: [
		...
		'Capacity Building for Digital Humanities in Tanzania: Developing digital skills among librarians, researchers, and students to strengthen the awareness in higher learning institutions in Tanzania.'
	]
};
