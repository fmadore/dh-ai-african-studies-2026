			...
			<div class="stack-xl lg:col-span-7">
				...
				<div class="gap-md flex flex-col sm:flex-row">
					<div class="animate-hero-cta">
						<AppButton href={positionPaperHref} size="xl">Read the position paper</AppButton>
					</div>
					<div class="animate-hero-cta-2">
						<AppButton variant="secondary" href={photosHref} size="xl">See the photos</AppButton>
					</div>
				</div>
			</div>

			<dl class="hero-facts animate-hero-cta-3 lg:col-span-5">
...
<section class="band padding-inline-section">
	<div class="content-width-wide animate-section-reveal" use:reveal>
		<div class="section-head">
			...
			<h2 class="heading-section">Workshop Purpose</h2>
		</div>
...
<section class="band band-sunken padding-inline-section">
	<div class="content-width-wide animate-section-reveal" use:reveal>
		<div class="section-head">
			<p class="section-head__eyebrow">02 — How we worked</p>
			<h2 class="heading-section">Three Work Streams</h2>
		</div>
		<p class="prose-serif mb-xl">
...
{#if stripPhotos.length > 0}
	<a href={photosHref} class="photo-strip" aria-label="Browse the workshop photo gallery">
...
<section class="band band-ink padding-inline-section">
	<div class="content-width-wide animate-section-reveal" use:reveal>
		<div class="section-head">
			<p class="section-head__eyebrow">03 — What came of it</p>
			<h2 class="heading-section">Workshop Outcomes</h2>
		</div>
			...
			{#each outcomes as outcome (outcome.title)}
				<a href={outcome.href} class="outcome-link card-surface card-surface--link">
					<span class="outcome-media">
						{#if outcome.media === 'photo' && stripPhotos.length > 0}
							<img
								...
								decoding="async"
							/>
						{:else if outcome.media === 'video' && firstInterview}
							<img
					...
					<span class="outcome-body">
						<span class="heading-sub heading-sm block">{outcome.title}</span>
						<span class="text-body-sm block">{outcome.description}</span>
					</span>
				</a>
			{/each}
		</div>
